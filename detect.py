            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        plot_one_box(xyxy, im0, label=label, color=(190,190,190), line_thickness=1)
...
#                 y = c2[1] - c1[1]
               # if x / y >= 0.8:  # 比例>0.8 可能会是摔倒
                print('进行人体姿态检测')#如果能改一下代码，将每个框出的人传到openpose里，有可能有效，但lightopenpose已经很准了，这么做没意义
                #if flag%10 <= 2:
                runOpenpose.run_demo(net, action_net, [im0], 256, False, boxList, True ,flag)  # 人体姿态检测 将图片和yolov5检测人体的框也传给openpose
                #break
