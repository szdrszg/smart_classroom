import sys
sys.path.append("D:\XXXXX\smart_classroom\code\ism_person_openpose-master\ism_person_openpose-master")
import torch
...
class Train:
    def __init__(self, root):
        ...
        self.net.load_state_dict(
            torch.load("D:\XXXXX\smart_classroom\code\ism_person_openpose-master\ism_person_openpose-master/action_detect/checkPoint/action.pt", map_location='cpu'))
        print(self.net)
    ...
    def __call__(self):
        for epoch in range(100):
            ...
            torch.save(self.net.state_dict(), f"./action_detect/action2.pt")  # 保存训练的数据


if __name__ == '__main__':
    train = Train('D:\XXXXX\smart_classroom\code\ism_person_openpose-master\ism_person_openpose-master/data')
    train()
